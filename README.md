...
BTech student focused on building practical software development skills through real projects and hands-on experimentation.

Previously worked as a **gym trainer**, which built strong discipline, consistency, and an execution mindset that I now apply to coding and problem solving.

Currently working with **HTML, CSS, JavaScript, Python, Git, and Docker**, while improving problem-solving through **Data Structures & Algorithms**.

Actively seeking **frontend / software development internships** where I can contribute, learn from real systems, and grow as a developer.
